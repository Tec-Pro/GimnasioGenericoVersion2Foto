...
public class RegistrarPagoGui extends javax.swing.JDialog {
    ...
    private void calcularTotal() {
        ...
        if (tablaDefault.getRowCount() > -1) {
            ...
            switch (i) {
                case 0:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 1:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(2)).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 2:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(3)).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 3:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(4)).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 4:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(5)).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 5:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(6)).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 6:
                    total.setText(totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(7)).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 7:
                    total.setText(totalB.divide(new BigDecimal(3),2, RoundingMode.HALF_UP).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 8:
                    total.setText(totalB.divide(new BigDecimal(2),2, RoundingMode.HALF_UP).setScale(2, RoundingMode.HALF_UP).toString());
                    break;
                case 9:
                    total.setText(totalB.setScale(2, RoundingMode.HALF_UP).toString());
    ...
    private void realizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_realizarActionPerformed
        ...
        switch (i) {
            case 0:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).setScale(2, RoundingMode.CEILING);
                break;
            case 1:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(2)).setScale(2, RoundingMode.CEILING);
                break;
            case 2:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(3)).setScale(2, RoundingMode.CEILING);
                break;
            case 3:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(4)).setScale(2, RoundingMode.CEILING);
                break;
            case 4:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(5)).setScale(2, RoundingMode.CEILING);
                break;
            case 5:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(6)).setScale(2, RoundingMode.CEILING);
                break;
            case 6:
                totalB = totalB.divide(new BigDecimal(30),2, RoundingMode.HALF_UP).multiply(new BigDecimal(7)).setScale(2, RoundingMode.CEILING);
                break;
            case 7:
                totalB = totalB.divide(new BigDecimal(3),2, RoundingMode.HALF_UP).setScale(2, RoundingMode.CEILING);
                break;
            case 8:
                totalB = totalB.divide(new BigDecimal(2),2, RoundingMode.HALF_UP).setScale(2, RoundingMode.CEILING);
                break;
            case 9:
