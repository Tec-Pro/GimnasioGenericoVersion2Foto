...
public class EnvioEmailControlador {
    ...
    public String url = "jdbc:mysql://localhost/" + DatosGenericos.dataBaseName;
    ...
    public void conectarMySQL() {
        try {
            ...
            conn = DriverManager.getConnection(url, DatosGenericos.userDB, DatosGenericos.passwordDB);
            if (conn != null) {
                conectadoMySQL = 1;
            }
    ...
    public boolean enviarMail(String email, String passw) throws MessagingException {
        ...
        if (!emailsModel.isEmpty()) {
            ...
            try {
                ...
                adjunto.setFileName("backUpGym.sql");
                ...
                message.setSubject("Backup mensual "+ DatosGenericos.nombreGimnasio);
    ...
    public static boolean enviarMailManualDieta(String fileName, Integer idSocio, String dietaRutina) {
        ...
        if (!emailsModel.isEmpty()) {
            ...
            // session.setDebug(true);
                ...
                message.setSubject(dietaRutina+" personalizada de "+DatosGenericos.nombreGimnasio);
                message.setContent(multiParte);
