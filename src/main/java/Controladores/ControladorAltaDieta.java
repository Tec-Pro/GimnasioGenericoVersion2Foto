...
public class ControladorAltaDieta implements ActionListener, CellEditorListener,ChangeListener {
    ...
    public void busqueda() {
        ...
        LazyList<Alimento> alimentos = Alimento.where("id like ? or nombre like ?  ", "%" + dietaGui.getTxtBusqueda().getText() + "%", "%" + dietaGui.getTxtBusqueda().getText() + "%");
        cargarEnTabla(alimentos);
        Base.commitTransaction();
    }

    public void busquedaDietas() {
        Base.openTransaction();
        LazyList<Dieta> dietas =Dieta.where("descripcion like ? or nombre like ?  ", "%" + dietaGui.getTxtBusquedaDietas().getText() + "%", "%" + dietaGui.getTxtBusquedaDietas().getText() + "%");
