...
CREATE DATABASE  IF NOT EXISTS `gym_tecpro` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `gym_tecpro`;
...
GRANT ALL PRIVILEGES ON gym_tecpro.* TO 'tecpro'@'localhost' IDENTIFIED BY 'tecpro';
